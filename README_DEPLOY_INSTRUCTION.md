...
## 9. Check the Status of Your Processes
...
## 12. Reloading or Re-running the Bot
...
## 13. Create a Bash Script

Create a script that performs the git pull operation and restarts the bot if there are updates.
...
## 14. Set Up a Cron Job
Set up a cron job that runs the script every two hours.
...
## 15. Test the Setup
You can manually run the script to test if it works as expected:
